  ...
  return (
    <header 
      ...
      className={`fixed top-0 inset-x-0 z-50 transition-all duration-500 select-none ${
        scrolled 
          ? 'py-3.5 bg-white/95 backdrop-blur-md border-b border-slate-100 shadow-md' 
          : 'py-5 bg-transparent'
      }`}
    >
        ...
        <div className="flex justify-between items-center h-16">
          ...
          >
            ...
            <div className="text-left">
              ...
              <span className={`text-[8px] tracking-[0.25em] font-extrabold uppercase leading-none block mt-1.5 transition-colors ${
                scrolled ? 'text-brand-emerald' : 'text-emerald-300'
              }`}>
                EXIM SERVICES
              </span>
            </div>
              ...
              return (
                <button
                  ...
                  className={`px-4.5 py-2.5 rounded-full text-[10px] font-bold tracking-wider transition-all uppercase duration-300 cursor-pointer relative ${
                    isActive 
                      ? (scrolled ? 'text-white font-extrabold' : 'text-slate-900 font-extrabold')
                      : (scrolled 
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            <button 
              ...
              className={`px-5 py-2.5 text-[10px] font-bold uppercase tracking-wider rounded-xl cursor-pointer transition-all shadow-sm ${
                scrolled 
                  ? 'bg-brand-forest hover:bg-brand-emerald text-white' 
