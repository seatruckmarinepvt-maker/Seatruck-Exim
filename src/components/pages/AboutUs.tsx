...
const LOCAL_TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    about_subtitle: "ABOUT SEATRUCK EXIM SERVICES",
    about_heading: "Global Sourcing. Trusted Partnerships.",
    about_p1: "Seatruck Exim Services is an international import and export company committed to facilitating the trade of agricultural commodities, food products, and industrial raw materials across global markets.",
    about_p2: "Through a trusted network of suppliers, quality-focused procurement practices, and reliable logistics coordination, we help businesses source products confidently while meeting international trade expectations.",
    about_p3: "We believe in transparency, professionalism, and long-term business relationships that create value for both suppliers and buyers.",
    ...
    philosophy_p1: "Successful international trade depends on transparency, consistency, and reliable execution. Every transaction is supported by responsible sourcing, quality verification, proper documentation, and efficient logistics coordination.",
    ...
    why_heading: "Why Choose Seatruck Exim Services?",
    ...
    cta_desc: "Whether you're sourcing agricultural commodities, food products, or industrial raw materials, Seatruck Exim Services is ready to support your business with dependable sourcing, documentation assistance, and logistics coordination.",
    cta_btn: "Contact Us",
    exim_desk_btn: "CONTACT EXIM DESK",
    home: "HOME",
    about_us: "ABOUT US"
  },
  es: {
    ...
    about_subtitle: "SOBRE SEATRUCK EXIM SERVICES",
    about_heading: "Abastecimiento Global. Alianzas Confiables.",
    about_p1: "Seatruck Exim Services es una empresa internacional de importación y exportación comprometida con facilitar el comercio de productos agrícolas, alimentos y materias primas industriales en los mercados globales.",
    about_p2: "A través de una red confiable de proveedores, prácticas de adquisición enfocadas en la calidad y coordinación logística confiable, ayudamos a las empresas a abastecerse de productos con confianza mientras cumplen con las expectativas del comercio internacional.",
    about_p3: "Creemos en la transparencia, el profesionalismo y las relaciones comerciales a largo plazo que crean valor tanto para los proveedores como para los compradores.",
    ...
    philosophy_p1: "El éxito del comercio internacional depende de la transparencia, la consistencia y la ejecución confiable. Cada transacción está respaldada por un abastecimiento responsable, verificación de calidad, documentación adecuada y coordinación logística eficiente.",
    ...
    why_heading: "¿Por qué elegir Seatruck Exim Services?",
    ...
    cta_desc: "Ya sea que esté abasteciéndose de productos agrícolas, alimentos o materias primas industriales, Seatruck Exim Services está listo para respaldar su negocio con un abastecimiento confiable, asistencia en documentación y coordinación logística.",
    cta_btn: "Contáctenos",
    exim_desk_btn: "CONTACTAR MESA EXIM",
    home: "INICIO",
    about_us: "NOSOTROS"
  },
  ar: {
    ...
    about_subtitle: "حول سي ترك إكسم سيرفيسز",
    about_heading: "التوريد العالمي. شراكات موثوقة.",
    about_p1: "سي ترك إكسم سيرفيسز هي شركة استيراد وتصدير دولية ملتزمة بتسهيل تجارة السلع الزراعية والمنتجات الغذائية والمواد الخام الصناعية عبر الأسواق العالمية.",
    about_p2: "من خلال شبكة موثوقة من الموردين، وممارسات شراء تركز على الجودة، وتنسيق لوجستي موثوق، نساعد الشركات على توريد المنتجات بثقة مع تلبية تطلعات التجارة الدولية.",
    ...
    why_heading: "لماذا تختار سي ترك إكسم سيرفيسز؟",
    ...
    cta_desc: "سواء كنت تبحث عن سلع زراعية، أو منتجات غذائية، أو مواد خام صناعية، فإن سي ترك إكسم سيرفيسز جاهزة لدعم عملك بتوريد موثوق، ومساعدة في الوثائق، وتنسيق لوجستي.",
    cta_btn: "اتصل بنا",
    exim_desk_btn: "اتصل بمكتب الاستيراد والتصدير",
    home: "الرئيسية",
    about_us: "من نحن"
  },
  hi: {
    ...
    about_subtitle: "सीट्रक एक्ज़िम सर्विसेज के बारे में",
    about_heading: "वैश्विक सोर्सिंग। विश्वसनीय साझेदारियां।",
    about_p1: "सीट्रक एक्ज़िम सर्विसेज एक अंतर्राष्ट्रीय आयात और निर्यात कंपनी है जो वैश्विक बाजारों में कृषि वस्तुओं, खाद्य उत्पादों और औद्योगिक कच्चे माल के व्यापार को सुविधाजनक बनाने के लिए प्रतिबद्ध है।",
    about_p2: "आपूर्तिकर्ताओं के एक विश्वसनीय नेटवर्क, गुणवत्ता-केंद्रित खरीद प्रथाओं और विश्वसनीय रसद समन्वय के माध्यम से, हम व्यवसायों को अंतर्राष्ट्रीय व्यापार अपेक्षाओं को पूरा करते हुए आत्मविश्वास से उत्पादों को सोर्स करने में मदद करते हैं।",
    ...
    why_heading: "सीट्रक एक्ज़िम सर्विसेज को क्यों चुनें?",
    ...
    tp_step5_desc: "सुरक्षित गंतव्य बंदरगाह वितरण और पूर्ण व्यापार पूर्ति सहायता।",
    ...
    cta_desc: "चाहे आप कृषि वस्तुओं, खाद्य उत्पादों, या औद्योगिक कच्चे माल की सोर्सिंग कर रहे हों, सीट्रक एक्ज़िम सर्विसेज भरोसेमंद सोर्सिंग, प्रलेखन सहायता और रसद समन्वय के साथ आपके व्यवसाय का समर्थन करने के लिए तैयार है।",
    cta_btn: "हमसे संपर्क करें",
    exim_desk_btn: "एक्ज़िम डेस्क से संपर्क करें",
    home: "होम",
  ...
  zh: {
    ...
    about_subtitle: "关于 SEATRUCK EXIM SERVICES",
    about_heading: "全球采购。值得信赖的合作伙伴。",
    about_p1: "Seatruck Exim Services 是一家国际进出口公司，致力于促进全球市场的大宗农产品、食品和工业原材料贸易。",
    about_p2: "通过值得信赖的供应商网络、注重质量的采购实践和可靠的物流协调，我们帮助企业充满信心地面向全球采购，同时满足国际贸易标准与期望。",
    about_p3: "我们坚信透明度、专业精神和长期的商业关系能够为供应商和买家双方创造共同价值。",
    
    principles_title: "我们的商业准则",
    p1_title: "可靠源头采购",
    p1_desc: "与经审核的供应商合作，确保一致的质量和可靠的供应。",
    p2_title: "品质与贸易合规",
    ...
    why_heading: "为什么选择 Seatruck Exim Services？",
    ...
    tp_step2: "供应商筛选",
    tp_step2_desc: "我们在网络中筛选、评估经资质审核的源头优质生产商并进行洽谈。",
    tp_step3: "质检与起运单证",
    ...
    cta_desc: "无论您是在寻找大宗农产品、食品配料还是工业原材料，Seatruck Exim Services 都随时准备通过可靠的源头采购、专业进出口单证和卓越物流，全方位支持您的业务。",
    cta_btn: "即刻联系我们",
    exim_desk_btn: "联系进出口贸易服务台",
    home: "首页",
    about_us: "关于我们"
  }
};
...
export default function AboutUs({ lang, onNavigate }: AboutUsProps) {
  ...
  return (
    <div id="about-root" className="bg-brand-warm-white text-slate-800 min-h-screen text-left font-sans select-none" dir={isRtl ? 'rtl' : 'ltr'}>
      ...
      {/* ================= HERO SECTION ================= */}
      <section 
        className="text-white py-28 md:py-36 relative overflow-hidden select-none bg-[#07241A]"
      >
        {/* Crisp Full-bleed Hero Background Image with enhanced clarity and vivid colours */}
        <img 
          src={ASSET_HEROES.about}
          alt="About Seatruck Corporate Heritage"
          fetchPriority="high"
          decoding="async"
          className="absolute inset-0 w-full h-full object-cover object-center z-0 brightness-[1.05] contrast-[1.10] saturate-[1.10]"
          onError={(e) => handleImageError(e, 'hero')}
        />

        {/* Subtle Brand Emerald Gradient Overlay - Softly darkens left 40% for text readability while keeping the right side bright & sharp */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#032015]/90 via-[#073322]/60 via-45% to-transparent rtl:bg-gradient-to-l rtl:from-[#032015]/90 rtl:via-[#073322]/60 rtl:via-45% rtl:to-transparent z-0 pointer-events-none" />

        {/* Network & Grid lines SVG backdrop overlay for global trade aesthetic */}
        <div className="absolute inset-0 z-0 opacity-[0.18] pointer-events-none">
          <svg className="w-full h-full text-emerald-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 500" preserveAspectRatio="none">
            <defs>
              <pattern id="hero-grid-about" width="40" height="40" patternUnits="userSpaceOnUse">
                <path d="M 40 0 L 0 0 0 40" fill="none" stroke="currentColor" strokeWidth="0.5"/>
              </pattern>
            </defs>
            <rect width="100%" height="100%" fill="url(#hero-grid-about)" />
            {/* Custom stylized trade lanes */}
            <circle cx="150" cy="150" r="4" fill="#D4AF37" />
            <circle cx="300" cy="220" r="5" fill="#D4AF37" />
            <circle cx="550" cy="180" r="4" fill="#D4AF37" />
            <circle cx="700" cy="280" r="6" fill="#D4AF37" />
            <circle cx="850" cy="160" r="4" fill="#D4AF37" />
            <circle cx="480" cy="350" r="5" fill="#D4AF37" />
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 relative z-10 space-y-6">
          ...
          >
            <div className="inline-flex items-center gap-2 border border-[#D4AF37]/80 text-[#D4AF37] bg-[#07241A]/80 backdrop-blur-md px-4 py-1.5 rounded-full text-[10px] font-mono tracking-widest uppercase font-bold shadow-lg">
          ...
          <motion.h1 
            ...
            className="text-4xl sm:text-6xl font-extrabold tracking-tight font-display text-white max-w-3xl leading-tight [text-shadow:_0_2px_12px_rgba(0,0,0,0.7)]"
          >
            {t.heritage}
          </motion.h1>
          ...
          <motion.p 
            ...
            className="text-emerald-50 sm:text-lg max-w-2xl leading-relaxed font-normal [text-shadow:_0_1px_8px_rgba(0,0,0,0.8)]"
          >
            {t.heritage_desc}
          </motion.p>
        </div>
      ...
      <div className="bg-white border-b border-slate-100 py-4 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 flex items-center gap-2 text-[11px] font-mono font-bold text-slate-400">
          <button onClick={() => onNavigate('home')} className="hover:text-[#0F3D2E] transition-colors cursor-pointer uppercase">{t.home}</button>
          <span>/</span>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-16 items-start">
            ...
            <div className="lg:col-span-7 space-y-6">
              <span className="text-xs font-bold font-mono text-[#D4AF37] uppercase tracking-widest block">
                {t.about_subtitle}
              </span>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0F3D2E] tracking-tight font-display leading-tight mb-4">
                {t.about_heading}
              </h2>
              
              <div className="border-l-4 border-[#0F3D2E] pl-6 space-y-5 text-slate-600 text-sm sm:text-base leading-relaxed">
                ...
                <p className="font-normal text-[#0F3D2E] font-medium italic">
                  {t.about_p3}
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 bg-white border border-slate-150 shadow-lg rounded-2xl p-8 space-y-6">
              <div>
                <h3 className="text-xs font-bold font-mono tracking-wider uppercase text-slate-400 mb-1">
                  {t.principles_title}
                </h3>
                <div className="w-12 h-1 bg-[#D4AF37] rounded"></div>
              </div>
                ...
                {[
                  ...
                  return (
                    <div key={idx} className="flex gap-4 items-start text-left">
                      <div className="p-3 rounded-xl bg-[#0F3D2E]/5 border border-[#0F3D2E]/10 text-[#0F3D2E] shrink-0">
                        <Icon className="w-5 h-5" />
                      </div>
                      <div>
                        <h4 className="text-sm font-bold text-slate-900 leading-snug">{val.title}</h4>
                        <p className="text-slate-500 text-xs mt-1 leading-normal">{val.desc}</p>
                      </div>
                    </div>
                  );
                })}
              ...
              <div className="pt-4 border-t border-slate-100">
                <button 
                  ...
                  className="w-full bg-[#0F3D2E] hover:bg-[#124734] text-white font-bold text-xs uppercase tracking-wider py-4 rounded-xl text-center cursor-pointer transition-all shadow-md flex items-center justify-center gap-2"
                >
                  <span>{t.exim_desk_btn}</span>
      ...
      <section className="py-24 bg-brand-warm-white border-t border-b border-slate-100 relative">
        <div className="max-w-7xl mx-auto px-6 sm:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-16 items-start">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0F3D2E] tracking-tight font-display leading-tight">
                {t.philosophy_heading}
              </h2>
              ...
              <div className="space-y-6 pt-8 border-t border-slate-200/60">
                {[
                  { num: "01", title: t.op_step1_title, desc: t.op_step1_desc },
                  { num: "02", title: t.op_step2_title, desc: t.op_step2_desc },
                  { num: "03", title: t.op_step3_title, desc: t.op_step3_desc }
                ].map((item, idx) => (
                  <div key={idx} className="flex gap-4 items-start">
                    <div className="w-12 h-12 rounded-xl border-2 border-[#0F3D2E]/20 text-[#0F3D2E] font-mono text-lg font-bold flex items-center justify-center shrink-0 bg-white shadow-sm">
                      {item.num}
                    </div>
                    <div>
                      <h4 className="text-sm font-bold text-slate-900 font-display tracking-wide">{item.title}</h4>
            ...
            <div className="lg:col-span-5 bg-white border border-slate-150 shadow-lg rounded-2xl p-8 space-y-6">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={idx} className="flex gap-4 items-start text-left">
                    <div className="p-2 rounded-lg bg-[#0F3D2E]/5 border border-[#0F3D2E]/10 text-[#0F3D2E] shrink-0 mt-0.5">
                      <ShieldCheck className="w-4 h-4" />
                    </div>
                    <div>
                      <h4 className="text-xs font-bold text-slate-900 uppercase font-mono tracking-wider leading-snug">{item.title}</h4>
                      <p className="text-slate-500 text-[11px] mt-1 leading-normal">{item.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
      ...
      <section className="py-24 bg-[#0F3D2E] text-white relative">
        <div className="max-w-7xl mx-auto px-6 sm:px-8">
            ...
            {[
              ...
              return (
                <motion.div 
                  key={idx}
                  whileHover={{ y: -6 }}
                  className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:border-[#D4AF37]/50 hover:bg-white/10 transition-all duration-300"
                >
                  <div className="w-12 h-12 rounded-full border border-[#D4AF37]/30 text-[#D4AF37] flex items-center justify-center mb-6 bg-[#D4AF37]/5">
                    <Icon className="w-5 h-5" />
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-4 flex flex-col justify-between space-y-8 h-full">
              <div className="space-y-4">
                <span className="text-xs font-bold font-mono text-[#C9A227] uppercase tracking-widest block">
                ...
                <div className="w-16 h-1 bg-[#C9A227] rounded"></div>
              </div>

              {/* Mission & Vision Cards Stack */}
              <div className="space-y-6 flex-1 flex flex-col justify-start">
                {/* Mission Card - India Hub */}
                <div className="bg-[#0F3D2E]/[0.03] border border-[#0F3D2E]/10 p-6 rounded-[18px] space-y-3 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 flex-1 flex flex-col justify-between group">
                  <div className="space-y-3">
                    <div className="flex gap-3 items-center justify-between">
                      <div className="flex gap-3 items-center">
                        <div className="w-10 h-10 rounded-full bg-[#0F3D2E] text-white flex items-center justify-center shrink-0 shadow-sm overflow-hidden">
                          <Target className="w-5 h-5" />
                        </div>
                        <div>
                          <h3 className="text-sm font-bold text-[#0F3D2E] uppercase tracking-wider">{t.mission_title}</h3>
                          <span className="text-[10px] text-[#C9A227] font-mono font-bold tracking-wider uppercase block">India Headquarters</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex justify-end items-center pt-2">
                    <ChevronRight className="w-4 h-4 text-[#C9A227] transform group-hover:translate-x-1 transition-transform" />
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex gap-3 items-center justify-between">
                      <div className="flex gap-3 items-center">
                        ...
                        <div>
                          <h3 className="text-sm font-bold text-[#0F3D2E] uppercase tracking-wider">{t.vision_title}</h3>
                          <span className="text-[10px] text-[#C9A227] font-mono font-bold tracking-wider uppercase block">UAE Gateway</span>
                        </div>
                      </div>
                    </div>
                    <p className="text-slate-600 text-xs leading-relaxed">
            ...
            <div className="lg:col-span-8 bg-white border border-[#E7E7E7] rounded-[18px] p-8 lg:p-10 shadow-lg flex flex-col justify-start space-y-12">
              <div>
                <span className="text-xs font-bold font-mono text-[#C9A227] uppercase tracking-widest block mb-1">
              ...
              <div className="relative pt-6">
                ...
                <div className="absolute top-[30px] left-[10%] right-[10%] h-[1px] border-t-2 border-dotted border-[#C9A227]/40 hidden md:block z-0"></div>
                
                {/* Vertical dotted gold line (mobile only) */}
                <div className="absolute left-[24px] top-[48px] bottom-[48px] w-[1px] border-l-2 border-dotted border-[#C9A227]/40 md:hidden z-0"></div>
                  ...
                  {[
                    ...
                    return (
                      <div key={idx} className="flex md:flex-col gap-5 md:gap-4 items-start md:items-center text-left md:text-center relative group">
                        {/* Circle and Icon */}
                        <div className="w-12 h-12 rounded-full bg-[#0F3D2E] border border-[#C9A227]/30 text-[#C9A227] flex items-center justify-center shadow-md relative z-10 shrink-0 hover:border-[#C9A227] hover:scale-105 transition-all duration-300">
                          <StepIcon className="w-5 h-5 text-white" />
                        </div>
                        
                        <div className="space-y-1">
                          <span className="font-mono text-[10px] font-bold text-[#C9A227] tracking-wider block">{step.num}</span>
      ...
      <section className="py-24 bg-[#0F3D2E] text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 relative z-10">
          ...
          <div className="text-center space-y-4 mb-16">
            ...
            <div className="w-24 h-1 bg-[#C9A227] mx-auto rounded"></div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              return (
                <div 
                  key={idx}
                  className="bg-white/[0.03] border border-white/10 backdrop-blur-md rounded-[18px] p-8 flex flex-col items-center text-center shadow-md hover:bg-white/[0.08] hover:border-[#C9A227]/30 hover:-translate-y-1.5 transition-all duration-300 hover:shadow-lg group"
                >
                  <div className="w-16 h-16 rounded-full border border-white/10 text-[#C9A227] flex items-center justify-center mb-6 shrink-0 group-hover:scale-105 transition-transform">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              return (
                <div 
                  key={idx}
                  className="bg-white border border-[#E7E7E7] rounded-[18px] p-6 sm:p-8 flex gap-5 items-start shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 text-left group"
                >
                  <div className="w-14 h-14 rounded-full bg-[#0F3D2E] text-white flex items-center justify-center shrink-0 shadow-sm group-hover:scale-105 transition-transform">
                    <Icon className="w-6 h-6 text-white" />
                  </div>
                  <div className="space-y-2 flex-1">
                    <h4 className="text-sm font-bold text-[#0F3D2E] leading-snug font-display uppercase tracking-wide">{principle.title}</h4>
      ...
      {/* ================= FINAL CTA ================= */}
      <section className="bg-[#0F3D2E] text-white py-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 sm:px-8 text-center relative z-10 space-y-8">
          ...
          <div className="pt-4">
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => onNavigate('contact')}
              className="inline-flex items-center gap-2 bg-[#D4AF37] hover:bg-[#c29f30] text-slate-900 font-bold text-xs uppercase tracking-widest px-8 py-4 rounded-xl transition-all shadow-lg cursor-pointer"
            >
              <span>{t.cta_btn}</span>
